...
Customize the demo for the selected service class. Remove protocol language from customer-facing copy.

## Week 3 — Provider A integration

Give Provider A only:

- the provider SDK,
- provider ID,
- testnet/dev ledger endpoint,
- integration guide.

Measure integration time and questions asked.

## Week 4 — Provider B integration

Repeat independently. Do not let Provider B reuse Provider A's private state.

## Week 5 — Pilot use

Issue passes, verify service, record claims, and support transfers.
